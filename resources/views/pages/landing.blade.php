...
@section('contenido')
	...
	<nav class="navbar navbar-expand-lg navbar-dark scrolling-navbar fixed-top">
      <div class="container">
        ...
        <!-- <a class="navbar-brand" href="#fondo" style="font-size: 30px; color: #FC7700;"><i class="fas fa-paw"></i></a> -->
        <div class="fondo">
      ...
      <section id="diferencia" class="container my-3">
          ...
          <div class="row align-items-center">
              ...
              <div class="col-lg-6 col-md-12 mb-lg-0 my-0" align="Right">
                  ...
                  <div class="my-4">
                    <h3 class="sub-title"><i class="fas fa-thumbtack red-text"></i> Misión</h3>
                  ...
                  <div class="my-0">
                    <h6 class="sub-title"><i class="fas fa-eye red-text"></i> Visión</h6>
                    <p class="grey-text">
                  ...
                  <div class="my-0">
                    <h6 class="sub-title"><i class="fas fa-hands-helping red-text"></i> Valores</h6>
                    <p class="grey-text">
        ...
        <div class="row" style="padding-bottom: 40px">
          ...
          <div class="col-md-4">                
              <div class="my-5 wow fadeInUp slow" data-wow-delay="0.1s">
                <h3 class="sub-title"><svg class="svg-inline--fa fa-clinic-medical fa-w-18 red-text" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="clinic-medical" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M288 115L69.47 307.71c-1.62 1.46-3.69 2.14-5.47 3.35V496a16 16 0 0 0 16 16h416a16 16 0 0 0 16-16V311.1c-1.7-1.16-3.72-1.82-5.26-3.2zm96 261a8 8 0 0 1-8 8h-56v56a8 8 0 0 1-8 8h-48a8 8 0 0 1-8-8v-56h-56a8 8 0 0 1-8-8v-48a8 8 0 0 1 8-8h56v-56a8 8 0 0 1 8-8h48a8 8 0 0 1 8 8v56h56a8 8 0 0 1 8 8zm186.69-139.72l-255.94-226a39.85 39.85 0 0 0-53.45 0l-256 226a16 16 0 0 0-1.21 22.6L25.5 282.7a16 16 0 0 0 22.6 1.21L277.42 81.63a16 16 0 0 1 21.17 0L527.91 283.9a16 16 0 0 0 22.6-1.21l21.4-23.82a16 16 0 0 0-1.22-22.59z"></path></svg><!-- <i class="fas fa-clinic-medical red-text"></i> --> Clínica Veterinaria</h3>
              ...
              <div class="my-0 wow fadeInUp slow" data-wow-delay="0.6s">
                <h6 class="sub-title"><svg class="svg-inline--fa fa-cut fa-w-14 red-text" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cut" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M278.06 256L444.48 89.57c4.69-4.69 4.69-12.29 0-16.97-32.8-32.8-85.99-32.8-118.79 0L210.18 188.12l-24.86-24.86c4.31-10.92 6.68-22.81 6.68-35.26 0-53.02-42.98-96-96-96S0 74.98 0 128s42.98 96 96 96c4.54 0 8.99-.32 13.36-.93L142.29 256l-32.93 32.93c-4.37-.61-8.83-.93-13.36-.93-53.02 0-96 42.98-96 96s42.98 96 96 96 96-42.98 96-96c0-12.45-2.37-24.34-6.68-35.26l24.86-24.86L325.69 439.4c32.8 32.8 85.99 32.8 118.79 0 4.69-4.68 4.69-12.28 0-16.97L278.06 256zM96 160c-17.64 0-32-14.36-32-32s14.36-32 32-32 32 14.36 32 32-14.36 32-32 32zm0 256c-17.64 0-32-14.36-32-32s14.36-32 32-32 32 14.36 32 32-14.36 32-32 32z"></path></svg><!-- <i class="fas fa-cut red-text"></i> --> Peluquería</h6>
                <p class="grey-text text-left">
                    Estética canina, sin uso de analgésicos y en tiempos cortos para disminuir el estrés de sus mascotas.
                </p>
              </div>
          ...
          <div class="col-md-4" >
            ...
            <div class="my-5 wow fadeInUp slow" data-wow-delay="0.1s">
              <h3 class="sub-title" align="Right">Farmacia 
                <svg class="svg-inline--fa fa-notes-medical fa-w-12 red-text" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="notes-medical" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg=""><path fill="currentColor" d="M336 64h-80c0-35.3-28.7-64-64-64s-64 28.7-64 64H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM192 40c13.3 0 24 10.7 24 24s-10.7 24-24 24-24-10.7-24-24 10.7-24 24-24zm96 304c0 4.4-3.6 8-8 8h-56v56c0 4.4-3.6 8-8 8h-48c-4.4 0-8-3.6-8-8v-56h-56c-4.4 0-8-3.6-8-8v-48c0-4.4 3.6-8 8-8h56v-56c0-4.4 3.6-8 8-8h48c4.4 0 8 3.6 8 8v56h56c4.4 0 8 3.6 8 8v48zm0-192c0 4.4-3.6 8-8 8H104c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h176c4.4 0 8 3.6 8 8v16z"></path></svg><!-- <i class="fas fa-notes-medical red-text"></i> --></h3>
            ...
            <div class="my-5 wow fadeInUp slow" data-wow-delay="0.6s"> 
              <h3 class="sub-title" align="Right">Alimetación <svg class="svg-inline--fa fa-bone fa-w-20 red-text" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bone" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg=""><path fill="currentColor" d="M598.88 244.56c25.2-12.6 41.12-38.36 41.12-66.53v-7.64C640 129.3 606.7 96 565.61 96c-32.02 0-60.44 20.49-70.57 50.86-7.68 23.03-11.6 45.14-38.11 45.14H183.06c-27.38 0-31.58-25.54-38.11-45.14C134.83 116.49 106.4 96 74.39 96 33.3 96 0 129.3 0 170.39v7.64c0 28.17 15.92 53.93 41.12 66.53 9.43 4.71 9.43 18.17 0 22.88C15.92 280.04 0 305.8 0 333.97v7.64C0 382.7 33.3 416 74.38 416c32.02 0 60.44-20.49 70.57-50.86 7.68-23.03 11.6-45.14 38.11-45.14h273.87c27.38 0 31.58 25.54 38.11 45.14C505.17 395.51 533.6 416 565.61 416c41.08 0 74.38-33.3 74.38-74.39v-7.64c0-28.18-15.92-53.93-41.12-66.53-9.42-4.71-9.42-18.17.01-22.88z"></path></svg><!-- <i class="fas fa-bone red-text"></i> --></h3> 
